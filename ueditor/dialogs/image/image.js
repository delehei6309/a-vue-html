...
//                }
            ...
            callback: function (editor, $w, url, state) {
                ...
                if (state == "SUCCESS") {
                    //显示图片计数+1
                    Upload.showCount++;
                    var $img = $("<img src='" + editor.options.imagePath + url.fileUrl + "' class='edui-image-pic' />"),
    ...
    var Upload = {
        ...
        submit: function (callback) {
            function dataUrltoBlob(data, fileType) {
                var tmp = data.split(',');
                ...
                return new Blob(new Uint8Array(array), {type: fileType || 'image/jpeg'});
            }
            ...
            $(me.dialog).delegate(".edui-image-file", "change", function (e) {
                ...
                var filename = e.currentTarget.files[0].name,
                    ...
                    maxSize = (4*1048576);//4M
                var toast = function (txt) {
                    var div = '<div class="toast-warp"><div class="toast-content">'+txt+'</div></div>';
                    $('body').append(div);
                    setTimeout(function(){
                        $('.toast-warp').stop().animate({
                            opacity:0
                        },500,function(){
                            $('.toast-warp').remove();
                        });
                ...
                var fd = new FormData();
                fd.append('file', e.currentTarget.files[0], filename);
